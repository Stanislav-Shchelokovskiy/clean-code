...
import (
	...
	"github.com/Stanislav-Shchelokovskiy/clean-code/service/worse/ds"
	"github.com/Stanislav-Shchelokovskiy/clean-code/service/worse/mocks"
...
func TestSearchByName(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			searcher.EXPECT().SearchByName(name).Return(rawItems, test.searcherErr).Once()
